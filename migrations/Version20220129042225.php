 ...
 */
final class Version20220129042225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username username VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(150) NOT NULL');
    }
